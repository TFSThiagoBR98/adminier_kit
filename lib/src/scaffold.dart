...
class AdminierScaffold extends StatefulWidget {
  ...
  /// {@end-tool}
  ///
  static AdminierScaffoldState of(BuildContext context) {
    assert(context != null);
    final AdminierScaffoldState? result =
        context.findAncestorStateOfType<AdminierScaffoldState>();
  ...
  @override
  AdminierScaffoldState createState() => AdminierScaffoldState();
}

class AdminierScaffoldState extends State<AdminierScaffold>
  ...
  void onDragStart(DragStartDetails details) {
    ...
    _canBeDragged = (isClosed && details.globalPosition.dx < 60) || isOpen;
  }

  void onDragUpdate(DragUpdateDetails details) {
    if (_canBeDragged) {
      double delta = (details.primaryDelta ?? 0) / 290;
  ...
  void onDragEnd(DragEndDetails details) async {
    ...
    if (details.velocity.pixelsPerSecond.dx.abs() >= _kMinFlingVelocity) {
      double visualVelocity = details.velocity.pixelsPerSecond.dx / 290;
                    ...
                    children: [
                      ...
                      ClipRect(
                        child: SizedOverflowBox(
                          size: Size(290 * (_animation.value as double),
                              double.infinity),
                          child: widget.drawer,
                        ),
                      ),
