...
/// [InternalExpansionTile] to save and restore its expanded state when it is scrolled
/// in and out of view.
///
...
class InternalExpansionTile extends StatefulWidget {
  /// Creates a single-line [ListTile] with a trailing button that expands or collapses
  /// the tile to reveal or hide the [children]. The [initiallyExpanded] property must
  /// be non-null.
  const InternalExpansionTile({
    Key? key,
    this.leading,
    required this.title,
    this.subtitle,
  ...
  @override
  _InternalExpansionTileState createState() => _InternalExpansionTileState();
}

class _InternalExpansionTileState extends State<InternalExpansionTile>
