...
class AdminierNavbar extends StatefulWidget implements PreferredSizeWidget {
  ...
  Size get preferredSize {
    return _PreferredNavbarSize(toolbarHeight, bottom?.preferredSize.height);
  }

  const AdminierNavbar({
    Key? key,
    this.leading,
  ...
  @override
  AdminierNavbarState createState() => AdminierNavbarState();
}

class AdminierNavbarState extends State<AdminierNavbar> {
  @override
  Widget build(BuildContext context) {
    return AppBar(
      ...
      toolbarOpacity: this.widget.toolbarOpacity,
      bottomOpacity: this.widget.bottomOpacity,
      toolbarHeight: this.widget.toolbarHeight,
      leadingWidth: this.widget.leadingWidth,
      backwardsCompatibility: this.widget.backwardsCompatibility,
      toolbarTextStyle: this.widget.toolbarTextStyle,
      titleTextStyle: this.widget.titleTextStyle,
      systemOverlayStyle: this.widget.systemOverlayStyle,
    );
  }
}

class _PreferredNavbarSize extends Size {
  const _PreferredNavbarSize(this.toolbarHeight, this.bottomHeight)
      : super.fromHeight(
